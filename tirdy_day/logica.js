...
const tecnologias = {
    ...
    "Blockchain": "A tecnologia por trás das criptomoedas e contratos inteligentes.",
...
const regexTecnologias = new RegExp(`^(${Object.keys(tecnologias).join("|")})$`, "i")
...
buttonSend.addEventListener("click", () => {
  ...
  if (answerButtonRadio) {
    ...
    if(answerButtonRadio != 'Especializando' && answerButtonRadio != 'FullStack'){
      showNewQuestion();
    }
  }
...
function verifyAnswer(answer) {
  ...
  } else if (answer == 'React' || answer == 'Vue'|| answer == 'C#'||answer == 'Java' ) {
    questions.push({
      question: "Você pretende continuar se Especializando ou seguir se desenvolvendo para se tornar um FullStack",
